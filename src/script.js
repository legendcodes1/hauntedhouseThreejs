...
const wallARMTexture = textureLoader.load(
  "./wall/castle_brick_broken_06_arm_1k"
);
...
const roofARMTexture = textureLoader.load("./roof/roof_slates_02_disp_1k.jpg");
...
const bushNormalTexture = textureLoader.load(
  "./bush/leaves_forest_ground__nor_gl_1k.jpg"
);
...
const graveNormalTexture = textureLoader.load(
  "./graves/plastered_stone_wallnor_gl_1k.jpg"
);
...
const bushGeomertry = new THREE.SphereGeometry(1, 16, 16);
...
const bush1 = new THREE.Mesh(bushGeomertry, bushMaterial);
bush1.scale.set(0.5, 0.5, 0.5);
bush1.position.set(0.8, 0.2, 2.2);
bush1.rotation.x = -0.75;

const bush2 = new THREE.Mesh(bushGeomertry, bushMaterial);
bush2.scale.set(0.25, 0.25, 0.25);
bush2.position.set(1.4, 0.1, 2.1);
bush2.rotation.x = -0.75;

const bush3 = new THREE.Mesh(bushGeomertry, bushMaterial);
bush3.scale.set(0.4, 0.4, 0.4);
bush3.position.set(-0.8, 0.1, 2.2);
bush3.rotation.x = -0.75;

const bush4 = new THREE.Mesh(bushGeomertry, bushMaterial);
...
//shadows
//mentoning now we support shadows
